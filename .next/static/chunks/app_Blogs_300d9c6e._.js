...
const Blog = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Blog.useEffect": ()=>{
            const processedBlogs = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Blogs$2f$blogData$2e$json__$28$json$29$__["default"].map({
                "Blog.useEffect.processedBlogs": (blog)=>({
                        ...blog,
                        createdAt: new Date(blog.createdAt)
                    })
            }["Blog.useEffect.processedBlogs"]);
            ...
            return categories.map({
                "Blog.useMemo[categoriesWithCounts]": (cat)=>({
                        ...
                        count: cat.id === "all" ? blogs.length : blogs.filter({
                            "Blog.useMemo[categoriesWithCounts]": (blog)=>blog.category === cat.id
                        }["Blog.useMemo[categoriesWithCounts]"]).length
                    })
            }["Blog.useMemo[categoriesWithCounts]"]);
        }
    }["Blog.useMemo[categoriesWithCounts]"], [
            ...
            return blogs.filter({
                "Blog.useMemo[filteredBlogs]": (blog)=>{
                    const matchesSearch = blog.title.toLowerCase().includes(searchTerm.toLowerCase()) || blog.content.toLowerCase().includes(searchTerm.toLowerCase()) || blog.tags?.some({
                        "Blog.useMemo[filteredBlogs]": (tag)=>tag.toLowerCase().includes(searchTerm.toLowerCase())
                    }["Blog.useMemo[filteredBlogs]"]);
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                blog.tags && blog.tags.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        blog.tags.slice(0, 3).map((tag, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(Blog, "A4lgM7h+3XBHnCJ0fUi+kTPXA0g=");
_c = Blog;
