...
"[project]/app/thumbnails/jira.png.mjs { IMAGE => \"[project]/app/thumbnails/jira.png (static in ecmascript)\" } [app-client] (structured image object, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/Blogs/blogData.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$thumbnails$2f$jira$2e$png$2e$mjs__$7b$__IMAGE__$3d3e$__$225b$project$5d2f$app$2f$thumbnails$2f$jira$2e$png__$28$static__in__ecmascript$2922$__$7d$__$5b$app$2d$client$5d$__$28$structured__image__object$2c$__ecmascript$29$__ = __turbopack_context__.i('[project]/app/thumbnails/jira.png.mjs { IMAGE => "[project]/app/thumbnails/jira.png (static in ecmascript)" } [app-client] (structured image object, ecmascript)');
;
const blogsData = [
    {
        id: "1",
        title: "Private AI: Run Advanced AI Models Offline on Android",
        thumbnail: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$thumbnails$2f$jira$2e$png$2e$mjs__$7b$__IMAGE__$3d3e$__$225b$project$5d2f$app$2f$thumbnails$2f$jira$2e$png__$28$static__in__ecmascript$2922$__$7d$__$5b$app$2d$client$5d$__$28$structured__image__object$2c$__ecmascript$29$__["default"],
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Blogs$2f$blogData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/Blogs/blogData.js [app-client] (ecmascript)");
;
...
_s(BlogImage, "W9GfmzYTY3XBoCCfsOqj93akyH0=");
_c = BlogImage;
const Blog = ()=>{
    _s1();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Blog.useEffect": ()=>{
            try {
                setIsLoading(true);
                const processedBlogs = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Blogs$2f$blogData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].map(validateBlog);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Blog.useEffect": ()=>{
            ...
            }["Blog.useEffect"], SEARCH_DEBOUNCE_MS);
            return ({
                "Blog.useEffect": ()=>{
                    if (searchTimeoutRef.current) {
                        clearTimeout(searchTimeoutRef.current);
    ...
    const formatDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Blog.useCallback[formatDate]": (date)=>{
    ...
    const getPreviewText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Blog.useCallback[getPreviewText]": (content, maxLength = PREVIEW_LENGTH)=>{
            if (!content) return "";
            if (content.length <= maxLength) return content;
            return content.substring(0, maxLength).trim() + "...";
        }
    }["Blog.useCallback[getPreviewText]"], []);
    ...
    const categoriesWithCounts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Blog.useMemo[categoriesWithCounts]": ()=>{
            const categoryCounts = blogs.reduce({
                "Blog.useMemo[categoriesWithCounts].categoryCounts": (acc, blog)=>{
                    acc[blog.category] = (acc[blog.category] || 0) + 1;
                    return acc;
                }
            }["Blog.useMemo[categoriesWithCounts].categoryCounts"], {});
            return categories.map({
                "Blog.useMemo[categoriesWithCounts]": (cat)=>({
                        ...cat,
    ...
    const filteredBlogs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Blog.useMemo[filteredBlogs]": ()=>{
            return blogs.filter({
                "Blog.useMemo[filteredBlogs]": (blog)=>{
                    const matchesSearch = !debouncedSearch || blog.title.toLowerCase().includes(debouncedSearch.toLowerCase()) || blog.content.toLowerCase().includes(debouncedSearch.toLowerCase()) || blog.tags?.some({
                        "Blog.useMemo[filteredBlogs]": (tag)=>tag.toLowerCase().includes(debouncedSearch.toLowerCase())
                    }["Blog.useMemo[filteredBlogs]"]) || blog.author?.toLowerCase().includes(debouncedSearch.toLowerCase());
                    const matchesCategory = selectedCategory === "all" || blog.category === selectedCategory;
                    return matchesSearch && matchesCategory;
                }
            }["Blog.useMemo[filteredBlogs]"]).sort({
                "Blog.useMemo[filteredBlogs]": (a, b)=>{
    ...
    const toggleExpanded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Blog.useCallback[toggleExpanded]": (blogId)=>{
            setExpandedCards({
                "Blog.useCallback[toggleExpanded]": (prev)=>{
                    if (prev.includes(blogId)) {
                        return prev.filter({
                            "Blog.useCallback[toggleExpanded]": (id)=>id !== blogId
                        }["Blog.useCallback[toggleExpanded]"]);
                    }
                    return [
                        ...prev,
                        blogId
    ...
    const handleCategorySelect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Blog.useCallback[handleCategorySelect]": (categoryId)=>{
            setSelectedCategory(categoryId);
            setIsMobileMenuOpen(false);
            setCurrentPage(1);
        }
    }["Blog.useCallback[handleCategorySelect]"], []);
    const handleSearchChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Blog.useCallback[handleSearchChange]": (e)=>{
            setSearchTerm(e.target.value);
        }
    }["Blog.useCallback[handleSearchChange]"], []);
    const handleTagClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Blog.useCallback[handleTagClick]": (tag)=>{
            setSearchTerm(tag);
            setCurrentPage(1);
        }
    }["Blog.useCallback[handleTagClick]"], []);
    const handleClearFilters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Blog.useCallback[handleClearFilters]": ()=>{
            setSearchTerm("");
            setSelectedCategory("all");
            setCurrentPage(1);
        }
    }["Blog.useCallback[handleClearFilters]"], []);
    const handleMobileMenuToggle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Blog.useCallback[handleMobileMenuToggle]": ()=>{
            setIsMobileMenuOpen({
                "Blog.useCallback[handleMobileMenuToggle]": (prev)=>!prev
            }["Blog.useCallback[handleMobileMenuToggle]"]);
        }
    }["Blog.useCallback[handleMobileMenuToggle]"], []);
    const handlePageChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Blog.useCallback[handlePageChange]": (page)=>{
            setCurrentPage(page);
            window.scrollTo({
                top: 0,
                behavior: "smooth"
    ...
    }["Blog.useCallback[handlePageChange]"], []);
    ...
    const structuredData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Blog.useMemo[structuredData]": ()=>{
            return {
                "@context": "https://schema.org",
                "@type": "Blog",
                name: "Tech Blog",
                description: "Insights, tutorials, and industry news",
                blogPost: paginatedBlogs.map({
                    "Blog.useMemo[structuredData]": (blog)=>({
                            "@type": "BlogPosting",
                            headline: blog.title,
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(BlogImage, {
                                                                src: blog.thumbnail,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            blog.tags && blog.tags.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    blog.tags.slice(0, MAX_VISIBLE_TAGS).map((tag, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s1(Blog, "wCEfiMm2siNWEqCUzfwJZGZMrs4=");
_c1 = Blog;
...
//# sourceMappingURL=app_208213ca._.js.map