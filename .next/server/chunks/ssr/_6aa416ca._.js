...
(()=>{
    const e = new Error("Cannot find module './downloadPdf.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
"use client";
...
function Home() {
    ...
    const handleYouTubeRedirect = ()=>{
        window.open("https://youtu.be/Hr5iLG7sUa0?si=KVqJ-ha_C7DCqAcv", "_blank");
    };
...
//# sourceMappingURL=_6aa416ca._.js.map