...
const projects = [
    ...
    },
    {
        ...
        description: "Scrape YouTube trending video data daily, store raw data in S3, process with Spark, transform with dbt, schedule with Airflow, and expose metrics via Grafana dashboard.",
...
const DataEngineeringRoadmap = ()=>{
    ...
    const handlePDFDownload = async ()=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Roadmaps$2f$Data$2f$downloadPdf$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["downloadRoadmapPDF"])(phases);
            if (result.success) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0d2b8a37._.js.map