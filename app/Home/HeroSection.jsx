...
import { ChevronRight, BookOpen, ArrowRight, Sun, Moon, Brain } from "lucide-react";
...
const HeroSection = ({ user, handleProtectedAction, username }) => {
  ...
  return (
    <div className={`transition-all duration-300 ${isDarkMode ? 'dark' : ''}`}>
      <div className="bg-white dark:bg-gray-900 transition-colors duration-300 px-4 sm:px-6 lg:px-8">
        ...
        <section className={`mb-8 lg:mb-12 transform transition-all duration-700 ${
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-2xl overflow-hidden hover:shadow-2xl dark:hover:shadow-3xl transition-all duration-300">
            ...
            <div className="block lg:hidden">
              ...
              <div className="p-4 sm:p-6 animate-slideInUp delay-200">
                ...
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-6 leading-relaxed transition-colors duration-300">
            ...
            <div className="hidden lg:flex">
              <div className="lg:w-1/2 p-8 xl:p-12 flex flex-col justify-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <h2 className="text-3xl xl:text-4xl font-bold text-gray-900 dark:text-white leading-tight mb-6 animate-slideInLeft transition-colors duration-300">
                  ...
                  <p className="text-lg xl:text-xl text-gray-600 dark:text-gray-300 mb-8 animate-slideInLeft delay-200 transition-colors duration-300 leading-relaxed">
              ...
              <div className="lg:w-1/2 relative flex items-center justify-center p-6 xl:p-8 group">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-72 xl:w-80 h-72 xl:h-80 bg-gradient-to-r from-blue-200/30 to-purple-200/30 dark:from-blue-800/20 dark:to-purple-800/20 rounded-full animate-spin-slow"></div>
                  <div className="absolute w-52 xl:w-60 h-52 xl:h-60 bg-gradient-to-r from-pink-200/30 to-yellow-200/30 dark:from-pink-800/20 dark:to-yellow-800/20 rounded-full animate-spin-reverse"></div>
                </div>
        ...
        <section className={`transform transition-all duration-700 delay-300 ${
          ...
          <div className="block sm:hidden space-y-3">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 text-center py-3 px-4 rounded-xl text-base font-semibold border border-blue-600 dark:border-blue-400 hover:bg-blue-50 dark:hover:bg-gray-700 transition-all duration-300 flex items-center justify-center gap-2 transform hover:scale-105 hover:shadow-lg active:scale-95"
              >
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white text-center py-3 px-4 rounded-xl text-base font-semibold transition-all duration-300 flex items-center justify-center gap-2 transform hover:scale-105 hover:shadow-lg active:scale-95 shadow-emerald-200 dark:shadow-emerald-900/30"
            >
          ...
          <div className="hidden sm:flex lg:hidden gap-3">
            ...
            <button
              onClick={() => handleProtectedAction("/Courses")}
              className="flex-1 bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 text-center py-3 px-5 rounded-xl text-lg font-semibold border border-blue-600 dark:border-blue-400 hover:bg-blue-50 dark:hover:bg-gray-700 transition-all duration-300 flex items-center justify-center gap-2 transform hover:scale-105 hover:shadow-lg active:scale-95"
            >
          ...
          <div className="hidden lg:flex gap-6 justify-center">
            ...
            <button
              onClick={() => handleProtectedAction("/Courses")}
              className="bg-white dark:bg-gray-700 text-blue-600 dark:text-blue-400 text-center py-4 px-8 rounded-xl text-lg font-bold border border-blue-600 dark:border-blue-400 hover:bg-blue-50 dark:hover:bg-gray-600 transition-all duration-300 transform hover:scale-105 hover:shadow-xl active:scale-95 min-w-[180px]"
            >
              Browse Courses
            </button>
            <button
              onClick={() => handleProtectedAction("/CareerGuidance")}
              className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white text-center py-4 px-8 rounded-xl text-lg font-bold transition-all duration-300 flex items-center justify-center gap-3 transform hover:scale-105 hover:shadow-xl active:scale-95 min-w-[180px] shadow-emerald-200 dark:shadow-emerald-900/50"
            >
