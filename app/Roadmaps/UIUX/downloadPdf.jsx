  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>UIUX Engineer Roadmap</Text>
        <Text style={styles.subtitle}>Your Complete Journey from Beginner to Professional</Text>
      </View>

      {/* Watermark */}
      <Text style={styles.watermark}>UIUX-EngineerRoadmap.com</Text>
...
export const downloadAdvancedRoadmapPDF = async (phases, options = {}) => {
  const {
    ...
    customTitle = "UIUX design Engineer Roadmap",
        ...
        <Page size={pageSize} orientation={orientation} style={styles.page}>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerText}>
              You've completed the UIUX engineer Roadmap and are now ready to take on professional  challenges.
            </Text>
          </View>
