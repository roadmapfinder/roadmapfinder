  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Tailwind Css roadmap </Text>
...
export const downloadRoadmapPDF = async (phases) => {
  try {
    ...
    const filename = `Tailwind-css-roadmap-${currentDate}.pdf`;
...
export const downloadAdvancedRoadmapPDF = async (phases, options = {}) => {
  const {
    ...
    customTitle = "Tailwind Css Roadmap",
        ...
        <Page size={pageSize} orientation={orientation} style={styles.page}>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerText}>
              You've completed the Tailwind Css Roadmap and are now ready to take on professional  challenges.
            </Text>
          </View>
