  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Davanci roadmap</Text>
...
export const PDFDownloadButton = ({ phases, className = "", children = "Download PDF" }) => (
  <PDFDownloadLink
    ...
    fileName={`Davanci-roadmap-${new Date().toISOString().split('T')[0]}.pdf`}
    className={className}
  >
        ...
        <Page size={pageSize} orientation={orientation} style={styles.page}>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerText}>
              You've completed the davanci Roadmap and are now ready to take on professional  challenges.
            </Text>
          </View>
