  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Mern Stack Engineer Roadmap</Text>
      ...
      <View style={styles.footer}>
        ...
        <Text style={styles.footerText}>
          You've completed the MERN Stack Engineer Roadmap and are now ready to take on professional challenges.
        </Text>
      </View>
...
export const downloadAdvancedRoadmapPDF = async (phases, options = {}) => {
  const {
    ...
    customTitle = "Mern Stack Engineer Roadmap",
    ...
    const AdvancedPDFDocument = () => (
      <Document>
        <Page size={pageSize} orientation={orientation} style={styles.page}>
          ...
          {includeWatermark && (
            <Text style={styles.watermark}>MernStackEngineerRoadmap.com</Text>
          )}
