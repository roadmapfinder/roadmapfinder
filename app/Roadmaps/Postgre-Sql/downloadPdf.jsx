  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Postgre Engineer Roadmap</Text>
...
export const downloadRoadmapPDF = async (phases) => {
  try {
    ...
    const filename = `Postgre-Engineer-roadmap-${currentDate}.pdf`;
...
export const PDFDownloadButton = ({ phases, className = "", children = "Download PDF" }) => (
  <PDFDownloadLink
    ...
    fileName={`Postgre-roadmap-${new Date().toISOString().split('T')[0]}.pdf`}
    className={className}
  >
...
export const downloadAdvancedRoadmapPDF = async (phases, options = {}) => {
  const {
    ...
    customTitle = "Postgre Engineer Roadmap",
        ...
        <Page size={pageSize} orientation={orientation} style={styles.page}>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerText}>
              You've completed Postgre Engineer Roadmap and are now ready to take on professional  challenges.
            </Text>
          </View>
