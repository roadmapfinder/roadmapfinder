  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Tableau roadmap </Text>
...
export const downloadRoadmapPDF = async (phases) => {
  try {
    ...
    const filename = `Tableau-roadmap-${currentDate}.pdf`;
...
export const PDFDownloadButton = ({ phases, className = "", children = "Download PDF" }) => (
  <PDFDownloadLink
    ...
    fileName={`Tableau-roadmap-${new Date().toISOString().split('T')[0]}.pdf`}
    className={className}
  >
