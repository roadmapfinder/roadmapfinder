...
import blockchainRoadmap from "./blockchainRoadmap.json";
...
export default function Home() {
  ...
  const handleDownload = async () => {
    await handleDownloadPDF(blockchainRoadmap, setDownloading);
  };

  // Handle YouTube redirect
  const handleYouTubeRedirect = () => {
    window.open(
      "https://youtu.be/ERAxd8gl1Eg?si=iXQcjmadXaM8D5kD",
      "_blank",
    );
  };
    ...
    >
      ...
      <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-7xl">
       ...
       Blockchain Developer
          ...
          >
            A comprehensive guide to becoming a Blockchain Developer,
