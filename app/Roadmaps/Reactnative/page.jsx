...
import { ChevronDown, Download, FileText, FolderOpen, Map, Menu, X, Loader2, HelpCircle , BarChart3 } from 'lucide-react';
        ...
        <div className="flex items-center justify-between mb-6 md:mb-8">
          <div className="flex items-center space-x-2 md:space-x-4">
            <h1 className="text-xl md:text-3xl font-bold text-gray-900">
              React Native <span className="text-blue-600">Mastery Roadmap</span>
            </h1>
          </div>
...
export default ReactNativeMasteryRoadmap;