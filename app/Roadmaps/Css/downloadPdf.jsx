  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Css Developer Roadmap</Text>
...
export const downloadAdvancedRoadmapPDF = async (phases, options = {}) => {
  const {
    ...
    customTitle = "Css Developer Roadmap",
        ...
        <Page size={pageSize} orientation={orientation} style={styles.page}>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerText}>
              You've completed the  Css Developer Roadmap and are now ready to take on professional  challenges.
            </Text>
          </View>
