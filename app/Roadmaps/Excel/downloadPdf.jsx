  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Excel Mastery Roadmap</Text>
        <Text style={styles.subtitle}>Your Complete Journey from Beginner to Professional</Text>
      </View>

      {/* Watermark */}
      <Text style={styles.watermark}>DSA-Roadmap.com</Text>
      ...
      <View style={styles.footer}>
        ...
        <Text style={styles.footerText}>
          You've completed the Excel mastery Roadmap and are now ready to take on professional design challenges.
        </Text>
      </View>
...
export const downloadAdvancedRoadmapPDF = async (phases, options = {}) => {
  const {
    ...
    customTitle = "Excel Mastery Roadmap",
      ...
      <Document>
        <Page size={pageSize} orientation={orientation} style={styles.page}>
          ...
          <View style={styles.footer}>
            <Text style={styles.footerTitle}>🎉 Congratulations!</Text>
            <Text style={styles.footerText}>
              You've completed the DSA Roadmap and are now ready to take on professional  challenges.
            </Text>
          </View>
