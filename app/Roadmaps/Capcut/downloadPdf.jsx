  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Capcut Editor Roadmap</Text>
...
export const downloadRoadmapPDF = async (phases) => {
  try {
    ...
    const filename = `Capcut-roadmap-${currentDate}.pdf`;
...
export const PDFDownloadButton = ({ phases, className = "", children = "Download PDF" }) => (
  <PDFDownloadLink
    ...
    fileName={`Capcut-roadmap-${new Date().toISOString().split('T')[0]}.pdf`}
    className={className}
  >
...
export const downloadAdvancedRoadmapPDF = async (phases, options = {}) => {
  const {
    ...
    customTitle = "Capcut Editor Roadmap",
        ...
        <Page size={pageSize} orientation={orientation} style={styles.page}>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerText}>
              You've completed Capcut Editor Roadmap and are now ready to take on professional  challenges.
            </Text>
          </View>
