          ...
          <div className="relative">
            ...
            <div className="text-center mt-8 md:mt-12 mx-4 p-6 md:p-8 bg-gradient-to-r from-blue-50 to-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-gray-700 text-base md:text-lg mb-4">
                You've mastered the Capcut Editor Roadmap and are now ready to work on operating systems, embedded systems, and high-performance applications.
              </p>
        ...
        <div className="flex items-center justify-between mb-6 md:mb-8">
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <h1 className="text-xl md:text-3xl font-bold text-gray-900">
              Capcut<span className="text-blue-600"> Editor Roadmap</span>
