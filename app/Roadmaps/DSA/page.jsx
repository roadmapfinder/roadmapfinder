...
import { phases, successTips, practicePlatforms } from './roadmapData';
      ...
      <div className="mt-8 md:mt-12 mx-4 p-6 md:p-8 bg-blue-50 rounded-lg border border-blue-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            {successTips.slice(0, 3).map((tip, index) => (
              <p key={index} className="text-blue-800 text-sm md:text-base">• {tip}</p>
            ))}
          </div>
          <div className="space-y-2">
            {successTips.slice(3, 6).map((tip, index) => (
              <p key={index} className="text-blue-800 text-sm md:text-base">• {tip}</p>
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {practicePlatforms.map((platform, index) => (
            <div key={index} className="text-center p-3 bg-white rounded-lg shadow-sm">
              <p className={`font-semibold ${platform.color}`}>{platform.name}</p>
