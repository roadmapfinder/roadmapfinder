  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Data Structure & Algorithm Roadmap</Text>
      ...
      <View style={styles.footer}>
        ...
        <Text style={styles.footerText}>
          You've completed the DSA Roadmap and are now ready to take on professional design challenges.
        </Text>
      </View>
