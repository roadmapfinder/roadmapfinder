  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>DevOps Engineer Roadmap</Text>
        <Text style={styles.subtitle}>Your Complete Journey from Beginner to Professional</Text>
      </View>

      {/* Watermark */}
      <Text style={styles.watermark}>DevOps-EngineerRoadmap.com</Text>
      ...
      <View style={styles.footer}>
        ...
        <Text style={styles.footerText}>
          You've completed the DevOps Engineer Roadmap and are now ready to take on professional design challenges.
        </Text>
      </View>
...
export const downloadAdvancedRoadmapPDF = async (phases, options = {}) => {
  const {
    ...
    customTitle = "DevOps Engineer Roadmap",
    ...
    const AdvancedPDFDocument = () => (
      <Document>
        <Page size={pageSize} orientation={orientation} style={styles.page}>
          ...
          {includeWatermark && (
            <Text style={styles.watermark}>DevopsEngineerRoadmap.com</Text>
          )}
          ...
          <View style={styles.footer}>
            <Text style={styles.footerTitle}>🎉 Congratulations!</Text>
            <Text style={styles.footerText}>
              You've completed the Devops Engineer Roadmap and are now ready to take on professional  challenges.
            </Text>
          </View>
