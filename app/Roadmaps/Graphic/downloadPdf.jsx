  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Graphic Designer Roadmap</Text>
        <Text style={styles.subtitle}>Your Complete Journey from Beginner to Professional</Text>
      </View>

      {/* Watermark */}
      <Text style={styles.watermark}>Graphic-Roadmap.com</Text>
...
export const downloadAdvancedRoadmapPDF = async (phases, options = {}) => {
  const {
    ...
    customTitle = "Graphic Designer Roadmap",
    ...
    const AdvancedPDFDocument = () => (
      <Document>
        <Page size={pageSize} orientation={orientation} style={styles.page}>
          ...
          {includeWatermark && (
            <Text style={styles.watermark}>GraphicDesignerRoadmap.com</Text>
          )}
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerText}>
              You've completed the Graphic Designer Roadmap and are now ready to take on professional  challenges.
            </Text>
          </View>
