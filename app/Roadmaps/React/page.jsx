...
import { ChevronDown, Download, FileText, FolderOpen, Map, Menu, X, Loader2, Code, HelpCircle } from 'lucide-react';
import { phases, essentialTools, careerPaths, finalTips } from './roadmapData';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {essentialTools.map((toolCategory, index) => (
              <div key={index} className="bg-white p-4 rounded-lg border">
                <h4 className="font-semibold text-purple-600 mb-2">{toolCategory.category}</h4>
                <ul className="text-sm text-gray-600 space-y-1">
        ...
        <div className="mt-8 md:mt-12 mx-4 p-6 md:p-8 bg-gradient-to-r from-green-50 to-green-50 rounded-lg border border-green-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {careerPaths.map((career, index) => (
              <div key={index} className="bg-white p-4 rounded-lg border">
                <h4 className="font-semibold text-green-600 mb-2">{career.title}</h4>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• Focus: {career.focus}</li>
                  <li>• Skills: {career.skills}</li>
                  <li>• Growth: {career.growth}</li>
