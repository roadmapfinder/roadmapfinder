  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Rust Developer Roadmap</Text>
        <Text style={styles.subtitle}>Your Complete Journey from Beginner to Professional</Text>
      </View>

      {/* Watermark */}
      <Text style={styles.watermark}>Rust Developer Roadmap.com</Text>
...
export const downloadAdvancedRoadmapPDF = async (phases, options = {}) => {
  const {
    ...
    customTitle = "Rust Developer  Roadmap",
        ...
        <Page size={pageSize} orientation={orientation} style={styles.page}>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerText}>
              You've completed Rust Developer Roadmap and are now ready to take on professional  challenges.
            </Text>
          </View>
