  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col space-y-8 sm:space-y-10 md:space-y-12">
        {/* Top Section */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-6 sm:gap-8 md:gap-10">
          {/* Logo + Description */}
          <div className="flex flex-col space-y-4 sm:space-y-6 lg:col-span-6">
            <Link href="/" className="flex items-center group">
              <div className="relative w-10 h-10 sm:w-12 sm:h-12 rounded-2xl overflow-hidden shadow-md group-hover:shadow-lg transition-all duration-300 group-hover:scale-105">
                <Image
                  src={Logo}
              ...
              <span className="text-blue-600 text-xl sm:text-2xl font-bold ml-3 group-hover:text-blue-700 transition-colors">
                RoadmapFinder
              </span>
            </Link>
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              <Link
                ...
                className="bg-white p-2.5 sm:p-3 rounded-xl shadow-md hover:shadow-lg hover:bg-blue-50 border border-gray-100 hover:border-blue-200 transition-all duration-300"
                aria-label="Twitter"
              >
                <Twitter
                  size={18}
                  className="sm:w-5 sm:h-5 text-gray-600 hover:text-blue-600 transition-colors"
                />
              </Link>
              <Link
              ...
              <Link
                ...
                className="bg-white p-2.5 sm:p-3 rounded-xl shadow-md hover:shadow-lg hover:bg-gray-50 border border-gray-100 hover:border-gray-200 transition-all duration-300"
                aria-label="Threads"
              >
                <ThreadsIcon
                  size={18}
                  className="sm:w-5 sm:h-5 text-gray-600 hover:text-gray-800 transition-colors"
                />
              </Link>
            </div>
          </div>
          ...
          {/* Quick Links */}
          <div className="flex flex-col space-y-4 sm:space-y-6 lg:col-span-3">
            <h3 className="text-lg sm:text-xl font-semibold text-gray-800 flex items-center">
              <div className="w-1 h-5 sm:h-6 bg-gradient-to-b from-blue-600 to-indigo-600 rounded-full mr-3"></div>
              Quick Links
            </h3>
            <nav className="flex flex-col space-y-2 sm:space-y-3">
              {[
                ...
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-sm sm:text-base text-gray-700 hover:text-blue-600 transition-all duration-300 hover:translate-x-1 flex items-center group"
                >
        ...
        {/* Bottom Section */}
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6 pt-4 sm:pt-6 border-t border-gray-200/70">
          ...
          <div className="flex items-center space-x-3">
            <span className="text-gray-600 text-xs sm:text-sm font-medium">Theme</span>
            <div className="relative">
              <div className="w-12 sm:w-14 h-6 sm:h-7 bg-gradient-to-r from-gray-200 to-gray-300 rounded-full flex items-center p-1 cursor-pointer hover:from-gray-300 hover:to-gray-400 transition-all duration-300 shadow-inner">
                <div className="bg-white w-4 h-4 sm:w-5 sm:h-5 rounded-full shadow-md transform translate-x-6 sm:translate-x-7 transition-transform duration-300 flex items-center justify-center">
